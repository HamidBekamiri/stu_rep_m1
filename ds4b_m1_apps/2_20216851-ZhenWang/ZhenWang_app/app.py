...
def read_objects():
    model_xgb = pickle.load(open('https://raw.githubusercontent.com/HamidBekamiri/stu_rep_m1/main/ds4b_m1_apps/2_20216851-ZhenWang/ZhenWang_app/model_xgb.pkl/model_xgb.pkl','rb'))
